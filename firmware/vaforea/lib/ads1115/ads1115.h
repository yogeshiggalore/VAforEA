...
enum ADS1115_MUX
{
	ADS1115_MUX_AIN0_AIN1 = 0b000,
	ADS1115_MUX_AIN0_AIN3 = 0b001,
	ADS1115_MUX_AIN1_AIN3 = 0b010,
	ADS1115_MUX_AIN2_AIN3 = 0b011,
...
enum ADS1115_PGA
{
	ADS1115_PGA_6_144 = 0b000,
	ADS1115_PGA_4_096 = 0b001,
	ADS1115_PGA_2_048 = 0b010,
	ADS1115_PGA_1_024 = 0b011,
	ADS1115_PGA_0_512 = 0b100,
	ADS1115_PGA_0_256 = 0b101,	
};

enum ADS1115_RUN_MODE
{
	ADS1115_RUN_MODE_CONTINOUS = 0,
	ADS1115_RUN_MODE_SINGLE = 1,
};

enum ADS1115_CONFIG_MODE
{
	ADS1115_CFG_MODE_SINGLE = 0,
	ADS1115_CFG_MODE_DIFREN = 1,
};
...
enum ADS1115_READ_CHANNEL
{
	ADS1115_READ_CHANNEL_0 = 0x00,
	ADS1115_READ_CHANNEL_1 = 0x01,
	ADS1115_READ_CHANNEL_2 = 0x02,
	ADS1115_READ_CHANNEL_3 = 0x04,
};
...
{
	uint8_t addr;
	enum ADS1115_RUN_MODE run_mode;
	enum ADS1115_CONFIG_MODE cfg_mode;
...
class ads1115 {
    public:
		...
		int begin( struct ads1115_config *ads_cfg, struct ads1115_data *ads_data);
